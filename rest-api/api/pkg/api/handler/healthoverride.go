...
// @Description List Machine health reports through NICo Core. Provider Admins and Viewers for their Machines; Tenant Admins for Machines their Tenant holds an Instance on.
// @Tags health-report
// @Accept json
// @Produce json
// @Security ApiKeyAuth
